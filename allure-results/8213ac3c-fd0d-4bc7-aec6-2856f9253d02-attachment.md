...
```
Error: locator.isVisible: Error: strict mode violation: locator('text=My Account') resolved to 3 elements:
...
Call log:
    - checking visibility of locator('text=My Account')
...
```ts
  ...
  21  |         this.lnkMyAccount = page.locator("text=My Account");
