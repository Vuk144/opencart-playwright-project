...
- Name: accountLogin.spec.ts >> Account Login Tests >> TC_02 Verify that user can login with valid credentials @master @sanity @regression
- Location: tests\accountLogin.spec.ts:34:9
        ...
        - list [ref=e99]:
          - listitem [ref=e100]:
            - link "Register for an affiliate account" [ref=e101] [cursor=pointer]:
              - /url: https://dweller-lumber-expulsion.ngrok-free.dev/opencart/upload/index.php?route=account/affiliate/add
